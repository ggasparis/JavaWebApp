...
<div class="content-wrapper">
    ...
    <div class="container" align="center">
        <div class="panel panel-default">
            <div class="panel-heading"><h4><strong><b>Purchase</b></strong></h4></div>
               ...
               <form name="form1" action="#">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="mybtn" type="submit" name="submit" value="ΥΠΟΒΟΛΗ" onclick="validateCard(document.form1.text1)"/>
            ...
            <script>
                function validateCard(inputtxt)
                {
                    ...
                    if (inputtxt.value.match(cardnum))
                    {
                        ...
                        window.location.replace("https://localhost:8443/addPoints?flag=1");
                        return true;
                    }
                    else{

                        alert("Μη έγκυρος αριθμός κάρτας.");
                        window.location.replace("https://localhost:8443/buyPoints");
                        return false;
                    }
